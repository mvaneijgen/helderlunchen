  ...
  <section id="content">
    ...
    <div id="container" class="transitions-enabled clearfix">
      ...
      <div class="item maisbrood col2" >
        ...
        <section>
          <h1>Maisbrood</h1>
          <input type='number' value="0" min="0" max="9" data-quantityPerUnit="25">          
        </section>
      </div>
      ...
      <div class="item ei col1">
        ...
        <section>
          <h1>Ei</h1>
          <input type='number' value="0" min="0" max="9" data-quantityPerUnit="6">          
        </section>
      </div>
      ...
      <div class="item appelstroop col2">
        ...
        <section>
          <h1>Appel stroop</h1>
          <input type='number' value="0" min="0" max="9" data-quantityPerUnit="55">          
        </section>
      </div>
      ...
      <div class="item kaas col2">
        ...
        <section>
          <h1>Kaas</h1>
          <input type='number' value="0" min="0" max="9" data-quantityPerUnit="12">
        </section>
      </div>
      ...
      <div class="item avocado col1">
        ...
        <section>
          <h1>Avocado</h1>
          <input type='number' value="0" min="0" max="9" data-quantityPerUnit="4">
        </section>
      </div>
      ...
      <div class="item eiersalade col1">
        ...
        <section>
          <h1>Eier salade</h1>
          <input type='number' value="0" min="0" max="9" data-quantityPerUnit="10">
        </section>
      </div>
      ...
      <div class="item honing col1">
        ...
        <section>
          <h1>Honing</h1>
          <input type='number' value="0" min="0" max="9" data-quantityPerUnit="80">          
        </section>
      </div>
      ...
      <div class="item makreel col1">
        ...
        <section>
          <h1>Makreel</h1>
          <input type='number' value="0" min="0" max="9" data-quantityPerUnit="14">
        </section>
      </div>
      ...
      <div class="item mayo col1">
        ...
        <section>
          <h1>Mayo</h1>
          <input type='number' value="0" min="0" max="9" data-quantityPerUnit="35">
        </section>
      </div>
